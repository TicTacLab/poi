...
final class UserDefinedFunction implements FreeRefFunction {
	...
	public FreeRefFunction getFunction(ValueEval[] args, OperationEvaluationContext ec) {
	...
	public ValueEval evaluate(ValueEval[] args, OperationEvaluationContext ec) {
		...
		FreeRefFunction targetFunc = getFunction(args, ec);
	...
	public ValueEval evaluateArray(ValueEval[] args, OperationEvaluationContext ec) {
		...
		ValueEval[] outGoingArgs = new ValueEval[nOutGoingArgs];
		System.arraycopy(args, 1, outGoingArgs, 0, nOutGoingArgs);
		return targetFunc.evaluateArray(outGoingArgs, ec);
	}
