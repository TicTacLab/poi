 ...
 */
public final class WeekdayFunc extends Var1or2ArgFunction {
	...
	*/
     ...
     */
    public ValueEval evaluate(int srcRowIndex, int srcColumnIndex, ValueEval arg0) {
        return evaluate(srcRowIndex, srcColumnIndex, arg0, new NumberEval(1));
    }
    ...
    public ValueEval evaluate(int srcRowIndex, int srcColumnIndex, ValueEval arg0, ValueEval arg1) {
        try {
            ...
            ValueEval serialDateVE = OperandResolver.getSingleValue(arg0, srcRowIndex, srcColumnIndex);
            ...
            int returnOption = 1;
            ValueEval ve = OperandResolver.getSingleValue(arg1, srcRowIndex, srcColumnIndex);
